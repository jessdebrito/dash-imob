...
export const SizeForm: React.FC<SettingsFromProps> = ({ initialData }) => {
  ...
  const title = initialData ? "Editar tamanhos" : "Criar tamanhos";
  const description = initialData
    ? "Editar tamanhos"
    : "Adicionar novo tamanhos";
  const toastMessage = initialData ? "Tamanhos editado." : "Tamanhos criado.";
